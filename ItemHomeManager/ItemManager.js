...
const ItemManager = ({ manager }) => {
    ...
    const ShowModal = () => {
        ...
        setSelectedStaff(manager); // Gán thông tin chi tiết của mục được chọn vào selectedStaff
    }
    const CloseMadal = () => {
    ...
    //Goi dien
    const makePhoneCall = () => {
        if (selectedStaff && selectedStaff.phoneManager) {
          const phoneNumber = selectedStaff.phoneManager;
    ...
    return (
        <View style={{ flex: 1, flexDirection: 'row', alignItems: "center", paddingBottom: 10, }}>
            ...
            <Text style={{ fontWeight: 'bold', marginLeft: 10, }}>{manager.username}</Text>
                        ...
                        {selectedStaff && (
                            <View styles={{ flex: 1 }}>
                                <View style={{ alignItems: 'center', marginBottom: 20 }}>
                                    <Text style={{ width: 60, height: 3, borderRadius: 10, backgroundColor: 'gray' }}></Text>
                                </View>
                                ...
                                <View style={{ flexDirection: 'row', marginTop: 20, marginLeft: 20 }}>
                                    ...
                                    <View style={{ marginLeft: 10 }}>
                                        <Text>{selectedStaff.phoneManager}</Text>
                                        <Text style={{ marginTop: 10 }}>{selectedStaff.emailManager}</Text>
                                    </View>
                                </View>
                            </View>
                        )}
