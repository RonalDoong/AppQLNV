...
const ItemManagerDepartmen = ({ manager }) => {
            ...
            <View style={styles.Container}>
                ...
                <View style={{ flexDirection: 'column', marginLeft: 'auto', justifyContent: 'center' }}>
                    ...
                    <View style={{borderBottomWidth:0.5}}>
                        <Text style={{ fontSize: 15, fontWeight: 'bold' }}><Icon name='person' size={17}/>{manager.username}</Text>
...
export default ItemManagerDepartmen;
